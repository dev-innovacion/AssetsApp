...
{
    public class MovementReport : MongoModel
    {
        ...
        public String GetRowsReportMov(Dictionary<string, string> fields = null, Int64 start = 0, Int64 end = 0)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (!fields.Keys.Contains("processes"))
                    {
                        cols.Add("processes");
                    }
